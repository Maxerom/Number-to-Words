...
def fetch_words(number, index):                       # convert each number to words
...
def convert_to_words(number):                               # Main starting function
    length = len(str(number))
    if length > 12:
        return 'This program supports a maximum of 12 digit'
